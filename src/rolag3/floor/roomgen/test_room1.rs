...
use crate::rolag3::floor::{floorgen::run::{GenFloorRoomContext, GenFloorRoomResponse}, room_object::{room_object_def::{NewRoomObjectContext, RoomObjectCollection}, cosmetic::ground1::new_ground1, wall::basic_wall::new_edge_wall, unit::{enemy1::new_enemy1, enemy2::new_enemy2, enemy3::new_enemy3, enemy::{square::{blue::new_square_blue, rgb_circle::new_square_rgb_circle, blue_diamond::new_square_blue_diamond, red::new_square_red, red_square::new_square_red_square, rgb_star4or8::new_square_rgb_star4, rgb_2tri::new_square_rgb_2tri, rgb_square2::new_square_rgb_square2}, regular_tri::{red_tri::new_regtri_red_tri, red::new_regtri_red, green::new_regtri_green, small_rgb_circle_or_tri::{new_regtri_small_rgb_circle, new_regtri_small_rgb_tri}}, circular_turret::bluntstar3::new_circular_turret_bluntstar3, rotating_laser::laser::new_rotating_laser, hexagon::{red_hexagon::new_hexagon_red_hexagon, green_hexagon::new_hexagon_green_hexagon, blue_hexagon::new_hexagon_blue_hexagon}, lightning::lorbg_fixed_path::{new_lorbg_fixed_path, make_logwc_path_polygon}, fatstar4::green::new_fatstar4_green, thinstar5::green::new_thinstar5_green, thinstar4::rgb_circle::new_thinstar4_group, thinstar3::red_circle::new_thinstar3_red_circle, big_circle::rgb_diamond::new_big_circle_rgb_diamond, small_square::{rgb::new_small_square_rgb, rgb_circle_or_tri::{new_small_square_rgb_circle, new_small_square_rgb_tri}}}, enemy4::new_enemy4, enemy5::new_enemy5, boss1::new_boss1}, damage::DamageColor, tiles::{black_hole::new_black_hole, accel_tile::new_accel_tile, ice_tile::new_ice_tile, damage_tile::new_damage_tile, key_tile::new_key_tile}}, rofiz::{rofiz_state::RofizState, rofiz_object::Transformation}, room::{RoomBuilderReq, RoomBuilder}};
...
fn make_test_room1(ctx: &mut GenFloorRoomContext) -> GenFloorRoomResponse {
    ...
    let enemy = new_square_rgb_circle(&mut new_floor_object_ctx, DamageColor::Blue, 12.0, 26.0);
    room_objects.add(Rc::new(RefCell::new(enemy)));
    ...
    let enemy = new_rotating_laser(&mut new_floor_object_ctx, Transformation::new(18.0, 9.0, 0.0), DamageColor::Blue, 5.0, 1.0);
    room_objects.add(Rc::new(RefCell::new(enemy)));

    let enemy = new_small_square_rgb(&mut new_floor_object_ctx, DamageColor::Green, 18.0, 12.0);
    room_objects.add(Rc::new(RefCell::new(enemy)));
    ...
    if false {
        ...
        new_regtri_small_rgb_circle(todo!(), todo!(), todo!(), todo!());
        new_regtri_small_rgb_tri(todo!(), todo!(), todo!(), todo!());
        new_small_square_rgb_circle(todo!(), todo!(), todo!(), todo!());
        new_small_square_rgb_tri(todo!(), todo!(), todo!(), todo!());
    }
