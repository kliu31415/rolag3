...
/* RedHexRedHex randomly translates in one of 6 directions and periodically shoots a wave of 6 projectiles.
*/
...
pub fn new_hexagon_red_hexagon(ctx: &mut NewRoomObjectContext, x: f64, y: f64) -> StandardUnit1 {
