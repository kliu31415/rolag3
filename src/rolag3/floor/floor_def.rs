...
use crate::{gfx::renderer::Renderer, rolag3::floor::{roomgen::{empty1::get_gen_room_fn_empty1, common::_100::{_100::get_gen_room_fn_common100, _101::get_gen_room_fn_common101, _102::get_gen_room_fn_common102a, _103::get_gen_room_fn_common103}}, floorgen::run::{GenFloorRoomFn, GenFloorRoomReqInfo}, room_object::{cosmetic::ground1::GroundTheme, wall::basic_wall::WallTheme, unit::enemy::{thinstar4::rgb_circle::new_thinstar4_group, square::{rgb_star4or8::{new_square_rgb_star4, new_square_rgb_star8}, rgb_2tri::new_square_rgb_2tri}, boss::{chromatic_wheel::new_boss_chromatic_wheel, mystic_prism::new_boss_mystic_prism, prismatic_prism::new_boss_prismatic_prism}}, damage::DamageColor}, draw::Color, rofiz::rofiz_state::RofizState}, util::{rng::Prng, lerp::lerp_f64}};
...
impl Floor {
                    ...
                    func: Box::new(|ctx: &mut GenFloorRoomContext| (get_gen_room_fn_boss_generic_rect(50, 50, false,
                        Box::new(|ctx: &mut NewRoomObjectContext| {
                            let position = |age: f64| -> (f64, f64) {
                             ...
                             Box::new([Rc::new(RefCell::new(new_square_rgb_2tri(ctx, DamageColor::Red, [DamageColor::Green, DamageColor::Blue], Box::new(position), std::f64::consts::PI)))])
                        }))(ctx))),
                },]
            },
        ];
    ...
    pub fn new_test4(renderer: &mut dyn Renderer, rng: &mut Prng, player: Rc<RefCell<Player>>) -> Self {
        ...
        let gen_normal_room_fns = vec![
            ...
            GenFloorRoomFn {weight: 2.0, func: get_gen_room_fn_common103()},
        ];
        let ground_theme = GroundTheme::Monocolor(Color::new(0.02, 0.0, 0.0, 1.0));
        let wall_theme = WallTheme::Monocolor(Color::new(0.1, 0.2, 0.3, 1.0));
        let gf_args = GenFloorArgs {
