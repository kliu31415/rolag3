...
fn make_test_room1(ctx: &mut GenFloorRoomContext) -> GenFloorRoomResponse {
    ...
    let enemies = new_thinstar4_red_group(&mut new_floor_object_ctx, 5, 21.0, 18.0);
