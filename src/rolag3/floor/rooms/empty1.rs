...
use crate::rolag3::floor::{room_object::{room_object_def::{RoomObjectId, NewRoomObjectContext, RoomObjectCollection}, wall::basic_wall::BasicWall, cosmetic::ground1::new_ground1}, room::{Room, RoomTile}, rofiz::rofiz_state::RofizState, draw::Color, floorgen::run::GenFloorRoomContext};
...
pub fn make_room_empty1(rng: &mut StdRng, room_object_id_counter: &mut RoomObjectId, widths: Range<u32>, heights: Range<u32>) -> Room {
    ...
    for x in 0..width {
        ...
        tiles[x as usize][0] = RoomTile::Wall;
    ...
    for x in 1..width-1 {
        for y in 1..height-1 {
            tiles[x as usize][y as usize] = RoomTile::Ground;
        }
    }
