...
use crate::{gfx::renderer::Renderer, rolag3::floor::{roomgen::{empty1::get_gen_room_fn_empty1, common::_100::{_100::get_gen_room_fn_common100, _101::get_gen_room_fn_common101, _102::get_gen_room_fn_common102a, _103::get_gen_room_fn_common103, _104::get_gen_room_fn_common104, _105::get_gen_room_fn_common105, _106::get_gen_room_fn_common106, _107::{get_gen_room_fn_common107a, get_gen_room_fn_common107b}, _108::get_gen_room_fn_common108, _109::get_gen_room_fn_common109, _110::{get_gen_room_fn_common110a, get_gen_room_fn_common110b}, _111::get_gen_room_fn_common111, _112::get_gen_room_fn_common112, _113::{get_gen_room_fn_common113_tri_circle, get_gen_room_fn_common113_tri_tri, get_gen_room_fn_common113_square_circle, get_gen_room_fn_common113_square_tri}, _114::{get_gen_room_fn_common114a, get_gen_room_fn_common114b}, _115::get_gen_room_fn_common115, _116::{get_gen_room_fn_common116a, get_gen_room_fn_common116b, get_gen_room_fn_common116c, get_gen_room_fn_common116d}, _117::{get_gen_room_fn_common117a, get_gen_room_fn_common117b}, _118::{get_gen_room_fn_common118a, get_gen_room_fn_common118b}, _119::{get_gen_room_fn_common119a, get_gen_room_fn_common119b, get_gen_room_fn_common119c}}}, floorgen::run::{GenFloorRoomFn, GenFloorRoomReqInfo}, room_object::{cosmetic::ground1::GroundTheme, wall::basic_wall::WallTheme, unit::enemy::{thinstar4::rgb_circle::new_thinstar4_group, square::rgb_star4or8::{new_square_rgb_star4, new_square_rgb_star8}, boss::{chromatic_wheel::new_boss_chromatic_wheel, mystic_prism::new_boss_mystic_prism, prismatic_prism::new_boss_prismatic_prism}, hexagon::rgb2_circle::new_hexagon_rgb2_circle, small_octagon::rgb_circle::new_small_octagon_rgb_circle}, damage::DamageColor}, draw::Color, rofiz::rofiz_state::RofizState}, util::rng::Prng};
...
impl Floor {
            ...
            GenFloorRoomReqInfo { 
                ...
                funcs: vec![GenFloorRoomFn {
                    ...
                    func: Box::new(|ctx: &mut GenFloorRoomContext| (get_gen_room_fn_boss_generic_rect(50, 50, false,
                        Box::new(|ctx: &mut NewRoomObjectContext| {
                             Box::new([Rc::new(RefCell::new(new_small_octagon_rgb_circle(ctx, DamageColor::Blue, 25.0, 25.0)))])
                        }))(ctx))),
                }, GenFloorRoomFn {
                    weight: 0.0, 
                    func: Box::new(|ctx: &mut GenFloorRoomContext| (get_gen_room_fn_boss_generic_rect(50, 50, false,
    ...
    pub fn new_test4(renderer: &mut dyn Renderer, rng: &mut Prng, player: Rc<RefCell<Player>>) -> Self {
        ...
        let gen_normal_room_fns = vec![
            ...
            GenFloorRoomFn {weight: 0.0, func: get_gen_room_fn_common113_tri_circle(40, 40, 3)},
            GenFloorRoomFn {weight: 0.0, func: get_gen_room_fn_common113_tri_tri(45, 45, 3)},
            GenFloorRoomFn {weight: 0.0, func: get_gen_room_fn_common113_square_circle(30, 30, 3)},
            GenFloorRoomFn {weight: 0.0, func: get_gen_room_fn_common113_square_tri(40, 40, 3)},
            GenFloorRoomFn {weight: 0.0, func: get_gen_room_fn_common114a(35, 35)},
            GenFloorRoomFn {weight: 0.0, func: get_gen_room_fn_common114b(35, 35)},
            GenFloorRoomFn {weight: 0.0, func: get_gen_room_fn_common115(35, 35)},
            GenFloorRoomFn {weight: 0.0, func: get_gen_room_fn_common116a(35, 35)},
            GenFloorRoomFn {weight: 0.0, func: get_gen_room_fn_common116b(35, 35)},
            GenFloorRoomFn {weight: 0.0, func: get_gen_room_fn_common116c(35, 35)},
            GenFloorRoomFn {weight: 0.0, func: get_gen_room_fn_common116d(35, 35)},
            GenFloorRoomFn {weight: 0.0, func: get_gen_room_fn_common117a(40, 40)},
